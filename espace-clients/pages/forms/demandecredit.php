...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 <a href="javascript:void(0);">Petroleum</a>.
                </div>
                <div class="version">
...
<section style="margin-top: 10%" class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Remplissez ce formulaire et soumettez. nous voulons avoir de nouveau la certitude de vos informations afin de traiter votre demande</h2>
            </div>
            <!-- Input -->
            <!-- Horizontal Layout -->
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li><a href="javascript:void(0);">Annuler</a></li>
                                        <li><a href="javascript:void(0);">Envoyer autre</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <form method="post" action="ajaxdemandecredit.php" class="form-horizontal">
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Nom et Prénom</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="name" name="name" class="form-control" placeholder="Enter votre email ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="email" id="email" name="email" class="form-control" placeholder="Enter votre email ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Adresse</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="adresse" name="adresse" class="form-control" placeholder="Enter votre adresse ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Revenus</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="revenus" name="revenus" class="form-control" placeholder="Entrer votre revenus mensuel">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Montant</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="montant" name="montant" class="form-control" placeholder="Entrer votre montant désiré">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="pays" name="pays" class="form-control" placeholder="Taper nom de  votre pays">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Numero Téléphone(format international)</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="numero" name="numero" class="form-control" placeholder="Taper nom de  votre pays">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <input class="waves-effect btn btn-primary bg-theme" type="submit" name="" value="Envoyer">
...
$(document).ready(function() {
    ...
    $('.bg-theme').click(function(e){
        ...
        if(revenus == ''){
            $('.message_box').html(
            '<span style="color:red;">Enter votre revenus mensuel !</span>'
            );
            $('#revenus').focus();
            return false;
            }
        ...
        if(montant == ''){
            $('.message_box').html(
            '<span style="color:red;">Enter votre montant désiré !</span>'
            );
            $('#montant').focus();
            return false;
            }
        ...
        if(adresse == ''){
            $('.message_box').html(
            '<span style="color:red;">Enter votre adresse !</span>'
            );
            $('#adresse').focus();
            return false;
            }
        ...
        //if(message == ''){
           // $('.message_box').html(
            ...
            ({
             type: "POST",
             url: "ajaxdemandecredit.php",
             data: "name="+name+"&email="+email+"&montant="+montant+"&pays="+pays+"&revenus="+revenus+"&adresse="+adresse+"&numero="+numero,
             beforeSend: function() {
             $('.message_box').html(
