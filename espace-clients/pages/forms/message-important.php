            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/ui/alerts.php">Nouveau virement</a>
                            </li>
                            <li>
                                <a href="pages/ui/animations.php">Historique des virement</a>
                            </li>
                            <li>
                                <a href="pages/ui/badges.php">Ajouter Bénéficiaire</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                             <li>
                                <a href="nouveau-message.php">Nouveau message</a>
                            </li>
                            <li>
                                <a href="message-envoyes.php">Message envoyé</a>
                            </li>
                            <li>
                                <a href="nouveau-recu.php">Message reçu</a>
                            </li>
                            <li>
                                <a href="message-important.php">Important</a>
                            </li>
                            <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Vos message imporatnts son disponibles ici</h2>
                        ...
                        <div class="body">
                            <div id="wizard_vertical">
                                ...
                                <section>
                                    <p>
                                        Lorem Message 1r sit amet, consectetur adipiscing elit. Integer ut nulla nunc. Maecenas
