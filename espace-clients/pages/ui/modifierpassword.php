...
<head>
    ...
    <title>PETROLEUM ESPACE CLEINT</title>
    <!-- Favicon-->
    ...
    <section style="margin-top: 10%" class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Laisser nous un message ici</h2>
            </div>
            <!-- Input -->
            <!-- Horizontal Layout -->
                            ...
                            <form method="post" class="form-horizontal">
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Enter votre mot de passe actuel</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="password" id="mdp" name="mdp" class="form-control" placeholder="Enter votre mot de paase ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="password" id="mdp2" name="mdp2" class="form-control" placeholder="Nouveau mot de passe">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <input class="waves-effect btn btn-primary bg-theme" type="submit" name="" value="Changer">
...
$(document).ready(function() {
    ...
    $('.bg-theme').click(function(e){
        ...
        if(mdp == ''){
            $('.message_box').html(
            '<span style="color:red;">Vos champs sont vide !</span>'
            );
            $('#mdp').focus();
            return false;
            }
        ...
        //if(message == ''){
           // $('.message_box').html(
            ...
            ({
             type: "POST",
             url: "ajaxnewpassword.php",
             data: "mdp="+mdp+"&mdp2="+mdp2+"&id="+id,
             beforeSend: function() {
             $('.message_box').html(
