    ...
    <header id="home">
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-sm-3 py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="index.php">Petroleum bank</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
                    ...
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="portfolio.php" class="drop-text">Portfolio</a></li>
                                    <li><a href="single.php" class="drop-text active">Blog Post</a></li>
                                    <li><a href="index.php" class="drop-text">More</a></li>
                                </ul>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 event-right">
                    <div class="event-right1">
                            ...
                            <div class="posts-grids">
                                <div class="row posts-grid mt-4">
                                    ...
                                    <div class="col-lg-8 col-sm-8 posts-grid-right mt-sm-0 mt-4">
                                        <h4>
                                            <a href="single.php" class="text-bl">Sed ut perspiciatis</a>
                                        </h4>
                                ...
                                <div class="row posts-grid mt-4">
                                    ...
                                    <div class="col-lg-8 col-sm-8 posts-grid-right mt-sm-0 mt-4">
                                        <h4>
                                            <a href="single.php" class="text-bl">Perspiciatis unde omni</a>
                                        </h4>
                                        <ul class="wthree_courses_events_list mt-2">
                                            <li class="mr-2 text-bl">
                        ...
                        <div class="tags mt-4 p-4 border">
                            ...
                            <ul class="mt-4">
                                <li>
                                    <a href="about.php" class="text-bl border">dfre</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">Gahydwq</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">qeers</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">hysert</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">hjwsa</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">sumgr</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">nhyewq</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">njyra</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">laiuwa</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">loghw</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">mhyu</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">mojjs</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">suisq</a>
                                </li>
                                <li>
                                    <a href="about.php" class="text-bl border">bhyfgh</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 single-left mt=lg=0 mt-4">
                    <div class="single-left1">
                        ...
                        <h5 class="card-title">
                            <a href="single.php" class="text-bl">Sed ut perspiciatis unde omnis iste.</a>
                        </h5>
                        <p>In consectetur, elit in scelerisque malesuada, tellus leo viverra massa, nec malesuada
                            turpis lectus
                            ac urna. Suspendisse ut neque orci. Phasellus tellus diam, pulvinar sit amet elit sit
