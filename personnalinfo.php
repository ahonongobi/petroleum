...
<body>
    ...
    <header id="home">
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-sm-3 py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="index.php"><img src="images/banner/logo.png"></a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
                    ...
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="portfolio.php" class="drop-text">Prêt Personnel</a></li>
                                    <li><a href="single.php" class="drop-text">Prêt Etudiant</a></li>
                                    <li><a href="single.php" class="drop-text">Rembourser un prêt</a></li>
                                    <li><a href="single.php" class="drop-text">Simuler un prêt</a></li>
                                    <li><a href="index.php" class="drop-text">Voir plus</a></li>

                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="langues" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i style=" font-size:20px;" class="fa fa-globe hidden-xs hidden-sm hidden-md"></i> <span class="hidden-lg">Langue</span></a>
                            ...
                            <li class="nav-right-sty mt-lg-0 mt-sm-4 mt-3">
                                <a href="login.php" class="reqe-button text-uppercase active">Connexion</a>
    ...
    <!-- //register -->
    <div id="gobi" class="modal-body align-w3">
        <?php  $mail = $_GET['email']; ?>
        <h4 class="w3pvt-title">Information Personnelle
        </h4>
        <form action="" method="post" class="p-sm-3">
            ...
            <div class="form-group">
                <label for="residence" class="col-form-label">Adreese actuelle</label>
                <input type="text" class="form-control" placeholder="Adreese actuelle" name="adresse" id="Adreese"
                >
            </div>
            <div class="form-group">
                <label for="pays" class="col-form-label">Pays de residence</label>
                <input type="tel" class="form-control" placeholder="Pays de residence" name="pays" id="Pays"
                >
            </div>
            <div class="form-group">
                <label for="recipient-email" class="col-form-label">Vous êtes hébergé par un tiers?</label>
                <input type="radio" class="form-control" name="radio" id="Radio" value="oui" 
                > Oui <input checked="" type="radio" class="form-control" name="radio" id="Radio" value="non" 
                > non
            </div>
            <div class="form-group">
                <label for="recipient-email" class="col-form-label">Notifications(canal par lequel vous souhaitez recevoir vos notifications bancaire)</label>
                <input type="radio" class="form-control" name="radio2" id="Radio2"
                value="sms"> SMS <input type="radio" class="form-control" name="radio2" id="Radio2"
                value="email"> Email
            </div>
            <div class="form-group">
                <label for="pays" class="col-form-label">Profession</label>
                <input type="tel" class="form-control" placeholder="Pays de residence" name="profession" id="Profession"
                >
            </div>
            <div class="form-group">
                <label for="pays" class="col-form-label">Revenus Mensuels Nets(EN Euros)</label>
                <input type="tel" class="form-control" placeholder="Pays de residence" name="revenue" id="Revenus"
                >
            </div>
            <div class="sub-w3l">
                <div class="sub-w3layouts_hub">
                    ...
                    <label for="brand2" class="mb-3 text-secondary">
                        <span></span>Conformément à la loi informatique et libertés du 6&nbsp;janvier&nbsp;1978 et 
                        au Règlement Européen UE 2016/679, les informations recueillies sont nécessaires au traitement de 
                        votre demande. Petroleum bank s'engage à ne pas communiquer vos informations à des fins commerciales à ses 
                        partenaires.
                    </label>
                </div>
            </div>
            <div class="right-w3l">
                <input type="submit" name="Submit" class="form-control bg-theme" value="Soumettre">
            </div>
...
$(document).ready(function() {
    ...
    $('.bg-theme').click(function(e){
        ...
        var adresse = $('#Adreese').val();
        if(adresse == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre adresse!</span>'
            );
            $('#Adreese').focus();
            return false;
            }
        ...
        if(pays == ''){
            $('.message_box').html(
            '<span style="color:red;">Enter votre pays!</span>'
            );
            $('#Pays').focus();
            return false;
            }
        ...
        if(radio == ''){
            $('.message_box').html(
            '<span style="color:red;">Veuillez faire un choix!</span>'
            );
            $('#Radio').focus();
            return false;
            }
        ...
        if(profession == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre profession!</span>'
            );
            $('#Profession').focus();
            return false;
            }
        ...
        if(revenus == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre revenus Mensuels!</span>'
            );
            $('#Revenus').focus();
            return false;
            }
        ...
        //if(message == ''){
           // $('.message_box').html(
            ...
            ({
             ...
             url: "ajax2.php",
             data: "adresse="+adresse+"&pays="+pays+"&radio="+radio+"&radio2="+radio2+"&profession="+profession+"&revenues="+revenus+"&email="+email,
             beforeSend: function() {
             $('.message_box').html(
