...
<body>
    ...
    <!-- //breadcrumbs -->
    <!-- register  -->
    <div class="modal-body align-w3 page">
        <h4 class="w3pvt-title">Information Générale
                            </h4>
        <form id="gobi" action="ajax.php" method="post"  class="p-sm-3" enctype="multipart/form-data">
            <div class="form-group">
                <label for="recipient-name" class="col-form-label">Nom et Prenoms</label>
                <input type="text" class="form-control" placeholder="votre nom et prenom" name="name" id="Name"
                >
            </div>
            <div class="form-group">
                <label for="recipient-name" class="col-form-label">Numero</label>
                <input type="tel" class="form-control" placeholder="votre numero" name="numero" id="Numero"
                >
            </div>
            <div class="form-group">
                <label for="recipient-email" class="col-form-label">Email</label>
                <input type="email" class="form-control" placeholder="petroleumbank@gmail.com" name="email" id="Email"
                >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <select class="custom-select" name="pays" id="inputGroupSelect05" aria-label="Example select with button addon">
       ...
       <div class="form-group">
        <label for="situation" class="col-form-label">Situation Matrimoniale</label>
        <select id="Matrimoniale" name="matrimoniale">
            <option value="mariee">Marié</option>
            <option value="celibataire">Célibataire</option>
            <option value="mariee">Divorecé</option>
        </select>
    </div>
    <div class="form-group">
        <label for="password2" class="col-form-label">Inserer une photo</label>
        <input type="file" class="form-control" accept=".jpg, .jpeg,.png"  id="Photo"  name="Photo" 
        >
    </div>
    <div class="sub-w3l">
    ...
    <div class="right-w3l">
        <input type="submit" id="Submit" name="Submit" class="form-control fa fa-long-arrow-right bg-theme" value="Soumettre">
    </div>
...
$(document).ready(function() {
    ...
    $('.bg-theme').click(function(e){
        ...
        if(name == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre nom!</span>'
            );
            $('#Name').focus();
            return false;
            }
        ...
        if(numero == ''){
            $('.message_box').html(
            '<span style="color:red;">Enter votre numero au format international!</span>'
            );
            $('#Numero').focus();
            return false;
            }

            var genre = $('#inputGroupSelect04').val();
        if(genre == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre genre!</span>'
            );
            $('#inputGroupSelect04').focus();
            return false;
            }
            var nationalite = $('#inputGroupSelect05').val();
        if(nationalite == ''){
            $('.message_box').html(
            '<span style="color:red;">Enter votre Nationalité!</span>'
            );
            $('#inputGroupSelect05').focus();
            return false;
            }
            var matrimoniale = $('#Matrimoniale').val();
        if(matrimoniale == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre genre!</span>'
            );
        ...
        if(dateofbirth == ''){
            $('.message_box').html(
            '<span style="color:red;">Entrer votre date de naissance!</span>'
            );
            $('#dateofbirth').focus();
            return false;
            }
        ...
        if(photo== ''){
            $('.message_box').html(
            '<span style="color:red;">Veuillez inserer une photo!</span>'
            );
            $('#Photo').focus();
            return false;
            }
