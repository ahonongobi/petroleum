            ...
            <div class="row pt-lg-4">
                <div class="col-lg-5">
                    <div class="wthree_pvt_title  mb-3">
                        <h4 class="w3pvt-title">Automobile
                        </h4>
                    ...
                    <div class="single_grid_text pt-lg-3">
                        ...
                        <p></p>
                        <a class="btn bg-theme mt-4 wthree-link-bnr" href="about.php">voir plus
                        </a>
                    </div>
                </div>
                <div class="col-lg-7 mt-lg-0 mt-4">
                    <div class="slide-img">
                      <img width="700" height="600" src="images/banner/g3.jpg">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="single_grid_w3_main align-w3">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                <h4 class="w3pvt-title">Votre Automobile en 3 etapes</h4>
                ...
                <div class="col-lg-6 mt-lg-0 mt-4">
                    <div class="container">
                        <div class="wthree_pvt_title">
                            <h4 class="w3pvt-title">Les avantages du Automobile
                            </h4>
